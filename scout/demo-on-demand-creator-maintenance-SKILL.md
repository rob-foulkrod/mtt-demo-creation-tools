...
validate, split, or publish the Scout demo-on-demand skill and related support files.

Do not load or expose these maintenance instructions during ordinary end-user demo package creation.
End-user demo workflows use `scout/demo-on-demand-SKILL.md`.
...
skills, references, generate-data files, change logs, updates, and documentation. Do not use a
...
When the user asks to update the Scout demo-on-demand skill:
